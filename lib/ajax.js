...
(function() {
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.fetch = function(params, options) {
      ...
      promise = (id = params.id) ? (delete params.id, this.find(id, params, options)) : this.all(params, options);
      return promise.fail(options.reject).done(function(record) {
        var results;

        results = _this.model.refresh(record, options);
