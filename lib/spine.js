...
(function() {
  var $, Controller, Events, JQueryPromise, Log, Model, Module, Spine, createObject, isArray, isBlank, makeArray, moduleKeywords,
    __slice = [].slice,
  ...
  Model = (function(_super) {
    ...
    Model.fetch = function(callbackOrParams, options) {
      ...
      if (typeof callbackOrParams === 'function') {
        ...
        return new Spine.Promise((function(_this) {
  ...
  JQueryPromise = (function() {
    JQueryPromise.resolve = function(result) {
      return new JQueryPromise(function(resolve) {
        return resolve(result);
      });
    };

    JQueryPromise.reject = function(error) {
      return new JQueryPromise(function(_, reject) {
        return reject(error);
      });
    };

    function JQueryPromise(fn) {
