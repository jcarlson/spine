...
(function() {
  var $, Controller, Events, Log, Model, Module, Promise, Spine, createObject, isArray, isBlank, makeArray, moduleKeywords,
    __slice = [].slice,
  ...
  Model = (function(_super) {
    ...
    Model.addRecord = function(record, options) {
      ...
      if ((_ref = (_base = this.irecords)[_name = record.id]) == null) {
        _base[_name] = record;
      }
      if ((_ref1 = (_base1 = this.irecords)[_name1 = record.cid]) == null) {
    ...
    Model.fetch = function(callbackOrParams, options) {
      var _this = this;
      ...
      if (typeof callbackOrParams === 'function') {
        ...
        return new Promise(function(resolve, reject) {
          ...
          return _this.trigger('fetch', callbackOrParams, options);
        });
      }
    };
  ...
  Promise = window.Promise || ((function() {
    function _Class(resolver) {
      this.then = __bind(this.then, this);
      var _this = this;

      this.dfd = new $.Deferred();
      resolver((function(result) {
        return _this.dfd.resolve(result);
      }), (function(error) {
        return _this.dfd.reject(error);
      }));
    }

    _Class.prototype.then = function() {
      var _ref;

      (_ref = this.dfd).then.apply(_ref, arguments);
      return this;
    };
